      ...
      <Box mb={10}>
        ...
        <Flex justify="center" wrap="wrap">
          <Box maxW="300px" m={4}>
            ...
            <Link to={`/projects/1`} color="teal.500" mt={2} display="block">Read More</Link>
          </Box>
          <Box maxW="300px" m={4}>
            ...
            <Link to={`/projects/2`} color="teal.500" mt={2} display="block">Read More</Link>
          </Box>
          <Box maxW="300px" m={4}>
            ...
            <Link to={`/projects/3`} color="teal.500" mt={2} display="block">Read More</Link>
          </Box>
        </Flex>
      </Box>
